...
namespace AiEnabled.Ai.Support.PriorityQ
{
  ...
  /// Found at https://github.com/BlueRaja/High-Speed-Priority-Queue-for-C-Sharp/tree/master/Priority%20Queue
  /// </summary>
      ...
      where TItem : GenericPriorityQueueNode<TPriority>
  {
    ...
    public GenericPriorityQueue(int maxNodes, Comparer<TPriority> comparer)
    {
#if DEBUG
      if (maxNodes <= 0)
      {
    ...
    {
      var cmp = _comparer.Compare(higher.Priority, lower.Priority);
