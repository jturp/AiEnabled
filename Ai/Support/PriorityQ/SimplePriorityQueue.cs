...
namespace AiEnabled.Ai.Support.PriorityQ
{
  ...
  public class SimplePriorityQueue<TItem, TPriority> : IPriorityQueue<TItem, TPriority>
  {
    ...
    /// <param name="itemEquality">The equality comparison function to use to compare TItem values</param>
    public SimplePriorityQueue(Comparer<TPriority> priorityComparer, IEqualityComparer<TItem> itemEquality)
    {
  ...
  public class SimplePriorityQueue<TItem> : SimplePriorityQueue<TItem, int>
  {
    ...
    /// Instantiate a new Priority Queue
    /// </summary>
    public SimplePriorityQueue() : base() { }

    /// <summary>
    /// Instantiate a new Priority Queue       
    /// </summary>
    /// <param name="itemEquality">The equality comparison function to use to compare TItem values</param>
    public SimplePriorityQueue(IEqualityComparer<TItem> itemEquality) : base(itemEquality) { }
